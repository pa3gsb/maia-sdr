...
set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33} [get_ports CLKIN_40MHz]
set_property -dict {PACKAGE_PIN H18 IOSTANDARD LVCMOS33} [get_ports CLK_DAC_CS]
set_property -dict {PACKAGE_PIN F19 IOSTANDARD LVCMOS33} [get_ports CLK_DAC_SCLK]
set_property -dict {PACKAGE_PIN F20 IOSTANDARD LVCMOS33} [get_ports CLK_DAC_SDI]
set_property -dict {PACKAGE_PIN J20 IOSTANDARD LVCMOS33} [get_ports LED0]
set_property -dict {PACKAGE_PIN H20 IOSTANDARD LVCMOS33} [get_ports LED1]
set_property -dict {PACKAGE_PIN G15 IOSTANDARD LVCMOS33} [get_ports EXT_GPIO_OUT[0]]
set_property -dict {PACKAGE_PIN K14 IOSTANDARD LVCMOS33} [get_ports EXT_GPIO_OUT[1]]
set_property -dict {PACKAGE_PIN J14 IOSTANDARD LVCMOS33} [get_ports EXT_GPIO_OUT[2]]
set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports EXT_GPIO_IN[0]]
set_property PULLTYPE PULLUP [get_ports EXT_GPIO_IN[0]]

create_clock -period 100.000 -name CLKIN_10MHz [get_ports CLKIN_10MHz]
create_clock -period  25.000 -name CLKIN_40MHz [get_ports CLKIN_40MHz]
set_clock_groups -asynchronous -group {CLKIN_10MHz}
set_clock_groups -asynchronous -group {CLKIN_40MHz}
set_false_path -from [get_cells i_system_wrapper/system_i/sync_ad_clock_0/inst/sync/check/lost_reg]
set_false_path -from [get_cells i_system_wrapper/system_i/sync_ad_clock_0/inst/sync/check/locked_reg]
