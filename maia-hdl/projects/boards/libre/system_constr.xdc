...
# =============================================================================
# Generated Clocks for MSK Modem
# =============================================================================

# l_clk is generated by AD9361 IP (4x rx_clk in LVDS mode = 245.76 MHz)
#create_generated_clock -name l_clk \
#    -source [get_ports rx_clk_in_p] \
#    -multiply_by 4 \
#    [get_pins i_system_wrapper/system_i/axi_ad9361/inst/l_clk]

# clk_div4 is our divide-by-4 of l_clk (61.44 MHz for msk_top)
#create_generated_clock -name clk_div4 \
#    -source [get_pins i_system_wrapper/system_i/clk_divider/inst/clk_div_ff_reg/C] \
#    -divide_by 4 \
#    [get_pins i_system_wrapper/system_i/clk_divider/inst/U_BUFG/O]

# CDC paths between l_clk and clk_div4 domains (handled by sync registers)
#set_false_path -from [get_clocks clk_div4] -to [get_clocks l_clk]
#set_false_path -from [get_clocks l_clk] -to [get_clocks clk_div4]

# Add clk_div4 to async group with PS clocks
#set_clock_groups -asynchronous -group [get_clocks {clk_fpga_0 clk_fpga_1 spi0_clk}] -group [get_clocks {clk_div4}]

# l_clk is async to PS clocks (CDC handled in RTL)
#set_clock_groups -asynchronous -group [get_clocks {clk_fpga_0 clk_fpga_1 spi0_clk}] -group [get_clocks {l_clk}]
