...
# RX Data pins (P1_D0 through P1_D11)
...
# TX Interface (FB_CLK_P mapped to K17 on XC7Z010CLG400)
...
# TX Data pins (P0_D0 through P0_D11)
...
# SPI Interface
set_property  -dict {PACKAGE_PIN  Y19  IOSTANDARD LVCMOS18  PULLTYPE PULLUP} [get_ports spi_csn]
