...
module b205_ref_pll#(parameter DEVICE="LTC2630")(
    input reset,
    input clk_40M_FPGA,      // 200 MHz sample clock
    ...
    // Can get a clean 10MHz output from here to put into 1PPS port.

    PLLE2_ADV #(.BANDWIDTH("OPTIMIZED"), .COMPENSATION("INTERNAL"),
		.DIVCLK_DIVIDE(1),
		.CLKFBOUT_MULT(30),
		.CLKOUT0_DIVIDE(6), // 200M
		.CLKOUT1_DIVIDE(30), // 40M
        .CLKOUT2_DIVIDE(120), //10M
		.CLKIN1_PERIOD(25.0)
	)
	clkgen (
    ...
    localparam REF_PERIOD_10MHZ_MIN=REF_PERIOD_10MHZ-(REF_PERIOD_10MHZ*20/1_000_000)-1;
    localparam REF_PERIOD_10MHZ_MAX=REF_PERIOD_10MHZ+(REF_PERIOD_10MHZ*20/1_000_000)+1; // modded to 20
